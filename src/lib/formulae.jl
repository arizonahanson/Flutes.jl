...
"""
  ℓₕ = toneholelength(𝑓=440.0; 𝑓ₜ=415.305, ϑ=25.0, ⌀=19.0, 𝑑=9.0, ℎ=3.5, 𝛥ℓₑ=57.0, 𝛥ℓᵥ=0.0)
...
"""
function toneholelength(𝑓=440.0; 𝑓ₜ=415.305, ϑ=25.0, ⌀=19.0, 𝑑=9.0, ℎ=3.5, 𝛥ℓₑ=57.0, 𝛥ℓᵥ=0.0)
  𝜆 = halfwavelength(𝑓; ϑ=ϑ)
  𝑔 = 𝑓/𝑓ₜ - 1
  𝜙 = (ℎ+𝑑) * (⌀/𝑑)^2 - 0.45⌀
  𝑧 = 𝑔/2 * √(1 + 4𝜙/(𝑔*𝜆)) - 𝑔/2
...
"""
  𝛥𝜆ₕ = closedholecorrection(𝑓=440.0; 𝑓ₜ=415.305, ϑ=25.0, ⌀=19.0, 𝑑=9.0, ℎ=3.5, 𝛥ℓₑ=57.0, 𝛥ℓᵥ=0.0)

Calculate correction due to closed hole
  for open frequency 𝑓, closed frequency 𝑓ₜ, temperature ϑ, tone-hole bore diameter ⌀,
  tone-hole height ℎ, tone-hole diameter 𝑑, embouchure correction 𝛥ℓₑ and closed-hole correction 𝛥ℓᵥ
"""
function closedholecorrection(𝑓=440.0; 𝑓ₜ=415.305, ϑ=25.0, ⌀=19.0, 𝑑=9.0, ℎ=3.5, 𝛥ℓₑ=57.0, 𝛥ℓᵥ=0.0)
  𝑘 = wavenumber(𝑓; ϑ=ϑ)
